...
class RemeDiConfig(PretrainedConfig):
    model_type = "RemeDi"
    ...
    def __init__(self, use_cache: bool = False, **kwargs):
        ...
        all_kwargs.update(
            {
                "architectures": all_kwargs.get("architectures", ["RemeDiModelLM"])
            }
        )
...
AutoConfig.register("RemeDi", RemeDiConfig)
